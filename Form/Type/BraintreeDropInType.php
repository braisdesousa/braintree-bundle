...
namespace nacholibre\BraintreeBundle\Form\Type;
...
class BraintreeDropInType extends AbstractType {
    ...
    public function finishView(FormView $view, FormInterface $form, array $options) {
        ...
        $factory = $this->container->get('braintree.factory');

        $client = $factory->get('clientToken');

        $token = $client::generate();

        $view->vars['client_token'] = $token;
        return;
